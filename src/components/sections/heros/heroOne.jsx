      ...
      <div className="container relative">
        <div className="flex flex-col items-center text-center relative z-10">
          <Title size={"7.5xl"} className={"font-normal max-w-[776px]"}>
            <span className="relative">RoyalBreed <span className="absolute -left-6 top-1 text-3xl text-[#0A6375]"><ThreeLine /></span></span>
            <span className="font-bold">International</span> <span className="font-bold text-destructive-foreground">Schools</span>
          </Title>
          ...
          <p className="pt-5 max-w-[431px]">At Royal Breed International School, every child is welcome to begin a journey of discovery, growth, and excellence.</p>
          <div className="mt-6">
