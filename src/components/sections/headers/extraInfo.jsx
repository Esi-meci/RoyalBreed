    ...
    return (
        <div className="mt-5">
            <div className="mt-5 mb-6">
                <a href="" className="bg-primary px-4 py-3 text-cream-foreground rounded-md sm:flex items-center gap-2.5  btn after:bg-green"> Student Portal <span><i className="fa-solid fa-arrow-right"></i></span> </a>
            </div>
            <div>
